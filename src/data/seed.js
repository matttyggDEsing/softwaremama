export const MODULE_DEFS = [
  ...
  { key: "dulce", label: "Mesa dulce", kind: "dishes", short: "Mesa dulce" },
  { key: "postre", label: "Postre", kind: "dish", short: "Postre" },
...
export function makeSeed() {
  ...
  const recipes = [
    ...
    rec("r_minitortas", "Mini tortas surtidas", "dulce", [item("minitortas", { g: 80 })]),
    rec("r_cupcakes", "Cupcakes", "dulce", [item("cupcakes", { u: 1 })]),
    rec("r_frutillas", "Frutillas con crema", "dulce", [item("frutillas", { g: 90 }), item("crema", { g: 25 })]),
    rec("r_alfajores", "Alfajores de maicena", "dulce", [item("alfajores", { u: 1 })]),
    rec("r_chocotorta", "Chocotorta", "dulce", [item("chocotorta", { g: 90 })]),
  ...
  const dishes = [
    ...
    dish("d_dul1", "Mini tortas surtidas", "dulce", "r_minitortas", 0.6),
    dish("d_dul2", "Cupcakes", "dulce", "r_cupcakes", 0.6),
    dish("d_dul3", "Frutillas con crema", "dulce", "r_frutillas", 0.55),
    dish("d_dul4", "Alfajores de maicena", "dulce", "r_alfajores", 0.6),
    dish("d_dul5", "Chocotorta", "dulce", "r_chocotorta", 0.55),
  ...
  const menus = [
    ...
    },
    {
      ...
      variants: [
        { id: "m2v1", name: "Buffet completo", modules: { buffet: ["r_pollhorn", "r_bondiola", "r_ensmixta", "r_griega"], dulce: ["d_dul1", "d_dul4"], trasnoche: "d_tra1" } },
        { id: "m2v2", name: "Buffet liviano", modules: { buffet: ["r_pollhorn", "r_ensmixta", "r_griega"], dulce: ["d_dul3"] } },
      ],
    },
    {
      ...
      variants: [
        ...
        { id: "m3v2", name: "Casamiento", modules: { entrada: "d_emp1", principal: "d_pri3", dulce: ["d_dul1", "d_dul2", "d_dul3"], postre: "d_pos3" } },
      ],
    },
  ];
  ...
  const events = [
    {
      ...
      modules: {
        ...
        dulce: { on: false, dishIds: [] },
        postre: { on: true, dishId: "d_pos1" },
    ...
    },
    {
      ...
      modules: {
        ...
        buffet: { on: false, recipeIds: [] },
        dulce: { on: true, dishIds: ["d_dul1", "d_dul2", "d_dul3"] },
        postre: { on: true, dishId: "d_pos3" },
        trasnoche: { on: false, dishId: null },
      },
    },
    {
      ...
      modules: {
        ...
        dulce: { on: true, dishIds: ["d_dul1", "d_dul4"] },
        postre: { on: false, dishId: null },
